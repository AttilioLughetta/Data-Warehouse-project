...
public class OSMImporter {
     ...
     */
    public boolean importData(String filePath) throws IOException, InterruptedException{
        ...
        command.add("-S");command.add(directory+System.getProperty("file.separator")+"default.style"); //style file
